...
const BlogCategories = ["Digital Marketing","SEO - SERP", "Local SEO", "Google Ads",  "Social Media Ads"];
    ...
    <Container>
        <Wrapper>
            <RecentsContainer>
                ...
                <RecentsWrapper>
                {
                    (newRecents.length != 0) && newRecents.map((blog) => {
                        return (
                            <MiniBlogCard key={blog.BlogId} blog={blog} />
                        )
                    })
                }
                </RecentsWrapper>
