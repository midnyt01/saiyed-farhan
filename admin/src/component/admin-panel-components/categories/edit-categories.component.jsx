...
const EditCategoriesOptions = ({type}) => {
  const { blogCategories, setBlogCategories, caseStudyCategories, setCaseStudyCategories } = useContext(BlogsContext);
...
export default EditCategoriesOptions;
